    ...
    class Chrome
    {
        ...
        public void TestSearchRozklad()
        {
            ...
            /*            element = driver.FindElement(By.XPath("/ html / body / div[1] / div[3] / form / div[1] / div[1] / div[3] / center / input[1]"));
                        element.Click();*/
            element = driver.FindElement(By.XPath("//*[@id=\"rso\"]/div/div[1]/div/div/div[1]/a/h3"));
            element.Click();
        ...
        public void TestEpicenterSchedule()
        {
            ...
            /*            element = driver.FindElement(By.XPath("/ html / body / div[1] / div[3] / form / div[1] / div[1] / div[3] / center / input[1]"));
                        element.Click();*/
            //click on Epicenter link
            element = driver.FindElement(By.XPath("//*[@id=\"rso\"]/div/div[1]/div/div/div/div/div[1]/a/h3"));
            element.Click();
        ...
        public void TestAbaddonPhaseBoots()
        {
            ...
            /*            element = driver.FindElement(By.XPath("/ html / body / div[1] / div[3] / form / div[1] / div[1] / div[3] / center / input[1]"));
                        element.Click();*/
            //click on Dotabuff link
            element = driver.FindElement(By.XPath("//*[@id=\"rso\"]/div/div[1]/div/div/div/div/div[1]/a/div/cite"));
            element.Click();
            //Click on Heroes
